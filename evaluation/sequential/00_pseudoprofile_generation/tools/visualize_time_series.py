...
LEGACY_ROOT_PSEUDODATA = REPO_ROOT / "evaluation/artifacts/pseudoprofiles/time_series_data/pseudodata"
SEQUENTIAL_ROOT_PSEUDODATA = REPO_ROOT / "evaluation/sequential/00_pseudoprofile_generation/outputs/pseudodata"
DEFAULT_ROOT_PSEUDODATA = SEQUENTIAL_ROOT_PSEUDODATA if SEQUENTIAL_ROOT_PSEUDODATA.exists() else LEGACY_ROOT_PSEUDODATA
