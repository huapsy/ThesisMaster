...
\subsection*{Casus C09 --- 27-jarige salesvertegenwoordiger}

\begin{complaintbox}[title={Casus C09 --- 27-jarige salesvertegenwoordiger; duur: 3 jaar}]
...
\subsection*{Casus C10 --- 52-jarige operationeel directeur}

\begin{complaintbox}[title={Casus C10 --- 52-jarige operationeel directeur; duur: ongeveer 9 maanden}]
...
\vspace{0.5em}
\subsection*{Casus C09 --- Deel 2}

\begin{complaintbox}[title={Casus C09 --- verkorte klachtomschrijving}]
...
\vspace{0.6em}
\newpage
\subsection*{Casus C10 --- Deel 2}

\begin{complaintbox}[title={Casus C10 --- verkorte klachtomschrijving}]
...
\vspace{0.5em}
\subsection*{Casus C09 --- Deel 3}

\begin{complaintbox}[title={Casus C09 --- 27-jarige salesvertegenwoordiger}]
...
\begin{tikzpicture}[node distance=0pt]
  \node[crnode] (cr1) at (0, 1.65) {CR-1\\Snelle stemmingsschommelingen};
  \node[crnode] (cr2) at (0, 0.55) {CR-2\\Afwijzingsreactiviteit};
  \node[crnode] (cr3) at (0, -0.55) {CR-3\\Impulsief gedrag};
  \node[crnode] (cr4) at (0, -1.65) {CR-4\\Relationele instabiliteit};
  \node[prnode] (p1) at (9, 2.2) {P1\\Emotieregulatievaardigheid};
  \node[prnode] (p2) at (9, 1.1) {P2\\Afwijzingsherwaardering};
  \node[prnode] (p3) at (9, 0.0) {P3\\Impulsuitstel};
  \node[prnode] (p4) at (9, -1.1) {P4\\Interpersoonlijke communicatie};
  \node[prnode] (p5) at (9, -2.2) {P5\\Gedifferentieerde stemmingsmonitoring};
...
\vspace{0.6em}
\newpage
\subsection*{Casus C10 --- Deel 3}

\begin{complaintbox}[title={Casus C10 --- 52-jarige operationeel directeur}]
...
\begin{center}
\begin{tikzpicture}[node distance=0pt]
  \node[crnode] (cr1) at (0, 1.65) {CR-1\\Chronische werkstress};
  \node[crnode] (cr2) at (0, 0.55) {CR-2\\Doorslaapinsomnie};
  \node[crnode] (cr3) at (0, -0.55) {CR-3\\Somatische stressklachten};
  \node[crnode] (cr4) at (0, -1.65) {CR-4\\Alcohol als copingstrategie};
  \node[prnode] (p1) at (9, 2.2) {P1\\Werkontkoppeling voor slaap};
  \node[prnode] (p2) at (9, 1.1) {P2\\Avondlijk alcoholgebruik};
  \node[prnode] (p3) at (9, 0.0) {P3\\Stressregulatie overdag};
  \node[prnode] (p4) at (9, -1.1) {P4\\Aerobe beweging};
  \node[prnode] (p5) at (9, -2.2) {P5\\Nachtelijke cognitieve arousal};
  \draw[edgeS] (cr2.east) -- (p1.west);
  \draw[edgeS] (cr1.east) -- (p1.west);
  \draw[edgeS] (cr4.east) -- (p2.west);
  \draw[edgeS] (cr2.east) -- (p2.west);
