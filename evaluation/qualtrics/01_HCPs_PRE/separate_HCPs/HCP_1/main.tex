...
\subsection*{Casus C01 --- 28-jarige softwareontwikkelaar}

\begin{complaintbox}[title={Casus C01 --- 28-jarige softwareontwikkelaar; duur: 2 maanden}]
...
\subsection*{Casus C02 --- 34-jarige administratief medewerker in de zorg}

\begin{complaintbox}[title={Casus C02 --- 34-jarige administratief medewerker in de zorg; duur: 3 maanden}]
...
\vspace{0.5em}
\subsection*{Casus C01 --- Deel 2}

\begin{complaintbox}[title={Casus C01 --- verkorte klachtomschrijving}]
...
\vspace{0.6em}
\newpage
\subsection*{Casus C02 --- Deel 2}

\begin{complaintbox}[title={Casus C02 --- verkorte klachtomschrijving}]
...
\vspace{0.5em}
\subsection*{Casus C01 --- Deel 3}

\begin{complaintbox}[title={Casus C01 --- 28-jarige softwareontwikkelaar}]
...
\begin{tikzpicture}[node distance=0pt]
  \node[crnode] (cr1) at (0, 1.65) {CR-1\\Inslaapproblemen};
  \node[crnode] (cr2) at (0, 0.55) {CR-2\\Cognitieve hyperarousal};
  \node[crnode] (cr3) at (0, -0.55) {CR-3\\Sociale anhedonie};
  \node[crnode] (cr4) at (0, -1.65) {CR-4\\Stressgerelateerde spierspanning};
  \node[prnode] (p1) at (9, 2.2) {P1\\Late avondschermtijd};
  \node[prnode] (p2) at (9, 1.1) {P2\\Dagelijkse taakaccumulatie};
  \node[prnode] (p3) at (9, 0.0) {P3\\Preslaap cognitieve offloading};
  \node[prnode] (p4) at (9, -1.1) {P4\\Sociale participatie};
  \node[prnode] (p5) at (9, -2.2) {P5\\Aerobe beweging};
...
\vspace{0.6em}
\newpage
\subsection*{Casus C02 --- Deel 3}

\begin{complaintbox}[title={Casus C02 --- 34-jarige administratief medewerker in de zorg}]
...
\begin{center}
\begin{tikzpicture}[node distance=0pt]
  \node[crnode] (cr1) at (0, 1.65) {CR-1\\Recidiverende paniekepisoden};
  \node[crnode] (cr2) at (0, 0.55) {CR-2\\Anticipatieangst};
  \node[crnode] (cr3) at (0, -0.55) {CR-3\\Situationele vermijding};
  \node[crnode] (cr4) at (0, -1.65) {CR-4\\Beroepsmatige interferentie};
  \node[prnode] (p1) at (9, 2.2) {P1\\Vermijdingsgedrag};
  \node[prnode] (p2) at (9, 1.1) {P2\\Veiligheidsgedrag};
  \node[prnode] (p3) at (9, 0.0) {P3\\Interoceptieve focus};
  \node[prnode] (p4) at (9, -1.1) {P4\\Geplande exposure};
  \node[prnode] (p5) at (9, -2.2) {P5\\Dagstructuur};
...
\checkitemBFS{2}{Schermtijd na 22:00 uur (min)}
\checkitemBFS{3}{Aantal dutjes overdag (min)}
\checkitemBFS{4}{Preslaap cognitieve offloading toegepast (ja/nee)}
\checkitemBFS{5}{Tijd in bed voor het opstaan (min)}
\checkitemBFS{6}{Aerobe beweging vandaag (min)}
\checkitemBFS{7}{Aantal sociale afspraken gepland (aantal)}
\checkitemBFS{8}{Nek- en schouderspanning in de namiddag (0--10)}
\checkitemBFS{9}{Blootstelling aan blauw licht voor het slapengaan (min)}
\checkitemBFS{10}{Piekeren over sociale afwijzing (0--10)}
\checkitemBFS{11}{Aantal maaltijden na 21.00 uur (aantal)}
\checkitemBFS{12}{Ochtendlichtblootstelling (min)}
\checkitemBFS{13}{Preslaap ontspanningsritueel uitgevoerd (ja/nee)}
\checkitemBFS{14}{Werkuren vandaag (uren)}
\checkitemBFS{15}{Alcoholinname in de avond (aantal)}
\checkitemBFS{16}{Slaapduur afgelopen nacht (uren)}
\checkitemBFS{17}{Aantal onbeantwoorde berichten (aantal)}
\checkitemBFS{18}{Pijnintensiteit lage rug (0--10)}
\checkitemBFS{19}{Hydratatie vandaag (glazen)}
\checkitemBFS{20}{Concentratie overdag (0--10)}
\vspace{0.4em}
...
\checkitemBFS{1}{Cafeine-inname voor 12.00 uur (aantal)}
\checkitemBFS{2}{Geplande exposure-oefening uitgevoerd (ja/nee)}
\checkitemBFS{3}{Rusthartslag bij ontwaken (slagen/min)}
\checkitemBFS{4}{Spierspanning in schouders (0--10)}
\checkitemBFS{5}{Veiligheidsgedrag frequentie (0--10)}
\checkitemBFS{6}{Sociale contacten vandaag (aantal)}
\checkitemBFS{7}{Lichamelijke sensaties zonder reactie geobserveerd (min)}
\checkitemBFS{8}{Stress op het werk (0--10)}
\checkitemBFS{9}{Inslaaptijd afgelopen nacht (min)}
\checkitemBFS{10}{Vermijdingssituatie betreden ondanks angst (ja/nee)}
\checkitemBFS{11}{Waterinname vandaag (glazen)}
\checkitemBFS{12}{Plezier in vrijetijdsactiviteit (0--10)}
\checkitemBFS{13}{Aantal dutjes overdag (min)}
\checkitemBFS{14}{Eetlust vandaag (0--10)}
\checkitemBFS{15}{Anticipatieangst voor gevreesde situatie (0--10)}
\checkitemBFS{16}{Stemmingsval in de namiddag (0--10)}
\checkitemBFS{17}{Stapelteller vandaag (aantal)}
\checkitemBFS{18}{Concentratie tijdens administratie (0--10)}
\checkitemBFS{19}{Alcoholinname vanavond (aantal)}
\checkitemBFS{20}{Tijd buitenshuis zonder ondersteuning (min)}
\vspace{0.4em}
\noindent\textbf{Totaal geselecteerd:}\hspace{0.5em}\rule{1.2cm}{0.25pt}\hspace{0.2em}/ 5
\end{responsebox}
