...
\subsection*{Casus C07 --- 46-jarige accountmanager}

\begin{complaintbox}[title={Casus C07 --- 46-jarige accountmanager; duur: 14 maanden}]
...
\subsection*{Casus C08 --- 38-jarige projectmanager}

\begin{complaintbox}[title={Casus C08 --- 38-jarige projectmanager; duur: sinds de kindertijd, duidelijk verergerd in de voorbije 12 maanden}]
...
\vspace{0.5em}
\subsection*{Casus C07 --- Deel 2}

\begin{complaintbox}[title={Casus C07 --- verkorte klachtomschrijving}]
...
\vspace{0.6em}
\newpage
\subsection*{Casus C08 --- Deel 2}

\begin{complaintbox}[title={Casus C08 --- verkorte klachtomschrijving}]
...
\vspace{0.5em}
\subsection*{Casus C07 --- Deel 3}

\begin{complaintbox}[title={Casus C07 --- 46-jarige accountmanager}]
...
\begin{tikzpicture}[node distance=0pt]
  \node[crnode] (cr1) at (0, 1.65) {CR-1\\Aanhoudende sombere stemming};
  \node[crnode] (cr2) at (0, 0.55) {CR-2\\Anergie};
  \node[crnode] (cr3) at (0, -0.55) {CR-3\\Sociale isolatie};
  \node[crnode] (cr4) at (0, -1.65) {CR-4\\Hopeloosheid};
  \node[prnode] (p1) at (9, 2.2) {P1\\Activiteitenschema};
  \node[prnode] (p2) at (9, 1.1) {P2\\Sociaal initiatief};
  \node[prnode] (p3) at (9, 0.0) {P3\\Slaapregelmaat};
  \node[prnode] (p4) at (9, -1.1) {P4\\Plezierige activiteit};
  \node[prnode] (p5) at (9, -2.2) {P5\\Cognitieve tegenspraak hopeloosheid};
...
\vspace{0.6em}
\newpage
\subsection*{Casus C08 --- Deel 3}

\begin{complaintbox}[title={Casus C08 --- 38-jarige projectmanager}]
...
\begin{center}
\begin{tikzpicture}[node distance=0pt]
  \node[crnode] (cr1) at (0, 1.65) {CR-1\\Aandachtsvolhoudingsproblemen};
  \node[crnode] (cr2) at (0, 0.55) {CR-2\\Plannings- en organisatiefouten};
  \node[crnode] (cr3) at (0, -0.55) {CR-3\\Interpersoonlijke onoplettendheid};
  \node[crnode] (cr4) at (0, -1.65) {CR-4\\Prestatieschaamte};
  \node[prnode] (p1) at (9, 2.2) {P1\\Extern taakbeheersysteem};
  \node[prnode] (p2) at (9, 1.1) {P2\\Interesse-gedreven activatie};
  \node[prnode] (p3) at (9, 0.0) {P3\\Bewust luisteren};
  \node[prnode] (p4) at (9, -1.1) {P4\\Taakvoltooiingsbekrachtiging};
  \node[prnode] (p5) at (9, -2.2) {P5\\Overgangsrituelen};
  \draw[edgeS] (cr2.east) -- (p1.west);
  \draw[edgeS] (cr1.east) -- (p1.west);
