...
def test_step05_intervention_generates_outputs(tmp_path: Path, repo_file_fn) -> None:
    ...
    assert (profile_out / "step05_hapa_component_candidates.json").exists()
    ...
    component_payload = json.loads((profile_out / "step05_hapa_component_candidates.json").read_text(encoding="utf-8"))
