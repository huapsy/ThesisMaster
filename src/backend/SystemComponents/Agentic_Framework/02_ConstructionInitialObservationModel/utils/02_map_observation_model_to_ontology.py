...
DEFAULT_CRITERION_CACHE_DIR = (
    str(
        REPO_ROOT
        / "src/backend/SystemComponents/Agentic_Framework/02_ConstructionInitialObservationModel/utils/helpers/embeddings/CRITERIONS"
    )
)
DEFAULT_PREDICTOR_CACHE_DIR = (
    str(
        REPO_ROOT
        / "src/backend/SystemComponents/Agentic_Framework/02_ConstructionInitialObservationModel/utils/helpers/embeddings/PREDICTORS"
    )
)
