...
def parse_args() -> argparse.Namespace:
    ...
    default_predictor_leaf_paths = (
        repo_root
        / "src/backend/SystemComponents/Agentic_Framework/02_ConstructionInitialObservationModel/utils/helpers/embeddings/PREDICTORS/PREDICTOR_leaf_paths_FULL.json"
    )
