...
DEFAULT_INPUT_JSON = str(
    REPO_ROOT / "src/backend/SystemComponents/PHOENIX_ontology/aggretated/01_raw/ontology_aggregated.json"
)
DEFAULT_PLOT_DIR = str(REPO_ROOT / "src/backend/utils/other/exploratory/summarize_ontology/plots")
DEFAULT_SUMMARY_DIR = str(REPO_ROOT / "src/backend/utils/other/exploratory/summarize_ontology/summary")
